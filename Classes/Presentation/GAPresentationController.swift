...
class GAPresentationController: UIPresentationController {
    ...
    convenience init(presentedViewController: UIViewController, presenting presentingViewController: UIViewController?, type: PresentationAnimationType, isShowMaskView: Bool = true, maskViewColor: UIColor = UIColor.clear) {
    ...
    override func presentationTransitionWillBegin() {
        if isShowMaskView {
            ...
            self.dimmingView.backgroundColor = maskViewColor
        }
